...
def main():
    ...
    parser.add_argument('--seq_length', type=int, default=20,#20
                        help='RNN sequence length')
    parser.add_argument('--pred_length', type=int, default=12,#12
...
def train(args):
    ...
    # Construct the NODES_INFO object
    NODES_INFO = Get_Nodes(args.batch_size, args.seq_length + 1)

    # Log directory
    log_directory = 'log_social_model/'
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch in range(dataloader.num_batches):
            ...
            for sequence in range(dataloader.batch_size):
                ...
                x_seq, y_seq, d_seq = x[sequence], y[sequence], d[sequence]
        ...
        # Log loss values
        log_file_curve_t.write(str(epoch)+','+ str(loss_epoch)+'\n')
        #-------------------------------------------------------
        ## Validation
        #-------------------------------------------------------
